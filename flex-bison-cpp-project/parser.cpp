...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PRINTLOG = 3,                   /* PRINTLOG  */
  YYSYMBOL_BREAK = 4,                      /* BREAK  */
  YYSYMBOL_IF = 5,                         /* IF  */
  YYSYMBOL_ELSE = 6,                       /* ELSE  */
  YYSYMBOL_WHILE = 7,                      /* WHILE  */
  YYSYMBOL_SCANF = 8,                      /* SCANF  */
  ...
  YYSYMBOL_FINISH = 23,                    /* FINISH  */
  YYSYMBOL_NAME = 24,                      /* NAME  */
  YYSYMBOL_ID_KW = 25,                     /* ID_KW  */
  YYSYMBOL_STATION = 26,                   /* STATION  */
  YYSYMBOL_SPEED = 27,                     /* SPEED  */
  YYSYMBOL_REGION = 28,                    /* REGION  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PRINTLOG", "BREAK",
  "IF", "ELSE", "WHILE", "SCANF", "SQRT", "SIN", "COS", "TAN", "LOG",
  "EXP", "POW", "PI", "INT_TYPE", "FLOAT_TYPE", "STR_TYPE", "BOOL_TYPE",
  "STOP", "START", "FINISH", "NAME", "ID_KW", "STATION", "SPEED", "REGION",
  "ROTATION", "INT", "FLOAT", "STRING", "IDENTIFIER", "EQUAL", "ARROW",
  "ASSIGNMENT", "AND", "OR", "NOT", "GT", "LT", "PLUS", "MINUS", "MULT",
  "DIV", "LP", "RP", "LCB", "RCB", "SC", "C", "COMMA", "$accept",
  "program", YY_NULLPTR
};
